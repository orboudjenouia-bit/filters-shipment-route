...
const createVehicle = async (req, res, next) => {
    ...
    const userId = req.user.id;
    const { plate_Number, type, vehicle_Name, color, year, capacity, photo } =
        req.body;
    ...
    await createNotifs(
        userId,
        'Vehicle Created',
        `Vehicle ${plate_Number} Created Successfully`,
        'routes',
        'vehicle',
        plate_Number
    )
...
const updateVehicle = async (req, res, next) => {
    ...
    if (vehicle.deleted_at !== null) {
        throw new AppError(
            'Cannot update a deleted vehicle',
            StatusCodes.BAD_REQUEST,
            'VEHICLE_DELETED'
        );
    }
    ...
    await createNotifs(
        userId,
        'Vehicle Updated',
        `Vehicle ${plate_Number} Updated Successfully`,
        'routes',
        'vehicle',
        plate_Number
    )
...
const deleteVehicle = async (req, res, next) => {
    ...
    await createNotifs(
        userId,
        'Vehicle Deleted',
        `Vehicle ${plate_Number} Deleted Successfully`,
        'routes',
        'vehicle',
        plate_Number
    )
